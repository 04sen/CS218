...
public class GameFrame extends JFrame{
    ...
    public static void main(String[] args) throws UnsupportedAudioFileException, IOException, LineUnavailableException{
        ...
        try{
            p.setContentPane(new JLabel(new ImageIcon(ImageIO.read(new File("C:\\Users\\PC\\Documents\\NetBeansProjects\\FinalAttemptAtSocket\\src\\Imgs\\background.jpg")))));
        } catch (IOException e) {
            e.printStackTrace();
        }
        p.pack();
    ...
    public void setUpGUI() throws UnsupportedAudioFileException, IOException, LineUnavailableException{
         ...
         paper_lb.setFont(new Font("Nyala", Font.BOLD , 16));
         ...
         title_lb.setFont(new Font("Nyala", Font.BOLD , 18));
         ...
         rules_lb.setFont(new Font("Nyala", Font.BOLD , 16));
         ...
         waiting_lb.setFont(new Font("Nyala", Font.BOLD , 12));
         ...
         lost_lb.setFont(new Font("Nyala", Font.BOLD , 12));
         ...
         win_lb.setFont(new Font("Nyala", Font.BOLD , 12));
         ...
         tie_lb.setFont(new Font("Nyala", Font.BOLD , 12));
