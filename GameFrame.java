...
public class GameFrame extends JFrame{
    ...
    ImageIcon sound_img = new ImageIcon("C:\\Users\\PC\\Documents\\NetBeansProjects\\FinalAttemptAtSocket\\src\\Imgs\\sound.png");
    ImageIcon mute_img = new ImageIcon("C:\\Users\\PC\\Documents\\NetBeansProjects\\FinalAttemptAtSocket\\src\\Imgs\\mute.png");
    ImageIcon rock_img = new ImageIcon("C:\\Users\\PC\\Documents\\NetBeansProjects\\FinalAttemptAtSocket\\src\\Imgs\\Rock.png");
    ImageIcon paper_img = new ImageIcon("C:\\Users\\PC\\Documents\\NetBeansProjects\\FinalAttemptAtSocket\\src\\Imgs\\paper.png");
    ImageIcon scissors_img = new ImageIcon("C:\\Users\\PC\\Documents\\NetBeansProjects\\FinalAttemptAtSocket\\src\\Imgs\\scissors.png");
    ImageIcon lizard_img = new ImageIcon("C:\\Users\\PC\\Documents\\NetBeansProjects\\FinalAttemptAtSocket\\src\\Imgs\\lizard.png");
    ImageIcon spock_img = new ImageIcon("C:\\Users\\PC\\Documents\\NetBeansProjects\\FinalAttemptAtSocket\\src\\Imgs\\spock.png");
    ImageIcon background = new ImageIcon("C:\\Users\\PC\\Documents\\NetBeansProjects\\FinalAttemptAtSocket\\src\\Imgs\\background.jpg");
    ...
    public void setUpGUI() throws UnsupportedAudioFileException, IOException, LineUnavailableException{
         ...
         audio_file = new File("C:\\Users\\PC\\Documents\\NetBeansProjects\\FinalAttemptAtSocket\\src\\Audio\\background.wav");
         ...
         title_lb.setText("<html>Welcome to Rock Paper Scissors Lizard Spock!</html>");
         title_lb.setOpaque(true);
         title_lb.setBackground(new java.awt.Color(100, 100, 100, 100));
         title_lb.setBounds(300, 10, 450, 50);
         title_lb.setHorizontalAlignment(title_lb.CENTER);
         title_lb.setVisible(true);
         title_lb.setForeground(Color.decode("#ffb7c5"));
         title_lb.setFont(new Font("Nyala", Font.PLAIN  , 20));
         
         player_lb.setText("<html>You are Player #" + playerID + "<html>");
         player_lb.setOpaque(true);
         player_lb.setBackground(new java.awt.Color(100, 100, 100, 100));
         player_lb.setBounds(400, 75, 250 , 50);
         player_lb.setHorizontalAlignment(player_lb.CENTER);
         player_lb.setVisible(true);
         player_lb.setForeground(Color.decode("#ffb7c5"));
         player_lb.setFont(new Font("Nyala", Font.PLAIN  , 20));
         ...
         rules_lb.setBackground(new java.awt.Color(100, 100, 100, 100));
         rules_lb.setBounds(20, 150, 200, 250);
         ...
         this.setContentPane(new JLabel(new ImageIcon(ImageIO.read(new File("C:\\Users\\PC\\Documents\\NetBeansProjects\\FinalAttemptAtSocket\\src\\Imgs\\background.jpg")))));
